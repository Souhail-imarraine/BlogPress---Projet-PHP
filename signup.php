                ...
                <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul
                        ...
                        <ul class="flex flex-col items-start gap-4">
                            <li>
                                <a href="login.php"
                                    class="no-underline text-gray-900 hover:text-amber-600 transition duration-200">
                                    Sign in
                                </a>
                            </li>
                            <li>
                                <a href="signup.php"
                                    class="bg-blue-500 text-white hover:bg-blue-700 transition duration-200 py-2 px-4 rounded">
                                    Sign up
                                </a>
                            </li>
                        </ul>
